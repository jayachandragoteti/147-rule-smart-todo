...
const TodoCard = ({ todo }: Props) => {
  ...
  return (
    <div
      className={`group rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border ${THEME_CLASSES.surface.card} ${THEME_CLASSES.border.base}`}
    >
      {todo.posterImage && (
